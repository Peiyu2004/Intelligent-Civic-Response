...
#     print(f"\n{'='*55}")
#     print(f"INTELLIGENT CIVIC RESPONSE SYSTEM — CiviScan")
#     print(f"{'='*55}")
...
#     IMAGE_FOLDER = r"D:\Project\Hackathon\Intelligent Civic Response\Intelligent-Civic-Response\backend\testing_img"
...
#         # If Option A fails (503, Timeout, No Internet), run Option B
#         print("\n" + "!"*50)
#         print(f"AI SERVER OFFLINE: {e}")
